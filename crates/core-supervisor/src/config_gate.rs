...
/// [`decide_verdict`] 的输入 —— 把「子进程跑成什么样」从 tokio 类型里剥出来。
///
/// 存在的唯一理由是**让每条腿都可测**：`tokio::time::error::Elapsed` 没有公开构造器，
