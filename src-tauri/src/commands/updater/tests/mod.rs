...
use crate::test_support::{crate_source, module_source, repo_file, TestDir};
...
fn src() -> &'static str {
    ...
    SRC.get_or_init(|| module_source("commands/updater"))
        .as_str()
}
...
fn core_update_check_is_wrapped_in_a_total_timeout() {
    let core_update_rs = crate_source("commands/updater/core_update.rs");
